        ...
        AlertDialog(
            ...
            title = {
                Column(Modifier.fillMaxWidth()) {
                    ...
                    Text(
                        "اختر طريقة إدخال البيانات التي تناسب طريقة عمل المحل.",
                        modifier = Modifier.fillMaxWidth(),
                        textAlign = TextAlign.Right,
                        color = Color.Gray,
                        fontSize = 12.sp
            ...
            text = {
                Column(
                    ...
                    RegistrationModeCard(
                        ...
                        icon = { Icon(Icons.Default.FormatListNumbered, null, tint = Purple, modifier = Modifier.size(28.dp)) },
                    ...
                    RegistrationModeCard(
                        ...
                        icon = { Icon(Icons.Default.Person, null, tint = Purple, modifier = Modifier.size(28.dp)) },
                        selected = selectedMode == RegistrationMode.INDIVIDUAL,
                        onClick = { selectedMode = RegistrationMode.INDIVIDUAL }
                    )
                    Text(
                        "يمكن تغيير الطريقة لاحقًا من هذه النافذة دون حذف بيانات المحل.",
...
@Composable
private fun RegistrationModeCard(
    title: String,
    description: String,
    ...
    Card(
        ...
        colors = CardDefaults.cardColors(
            containerColor = if (selected) Purple.copy(alpha = 0.10f) else Color(0xFFF8F7FA)
        ),
        ...
        Row(
            ...
            if (selected) {
                Icon(Icons.Default.CheckCircle, null, tint = Purple, modifier = Modifier.size(24.dp))
            } else {
                icon()
            }
        }
